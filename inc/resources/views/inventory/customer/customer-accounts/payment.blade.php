...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Customer's Payment Collection</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-6 offset-md-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('inventory.customer.account.payment-store') }}" method="post">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="">Customer: <i class="text-danger">*</i></label>
                    <select class="form-control select2" id="project_category" name="c_name" style="width: 100%;">
                  ...
                  <div class="form-group">
                    <label for="">Projects: <i class="text-danger">*</i></label>
                    <select class="form-control select2 project_category_wrapper" name="project" onchange="loadAvailableBalanceOfCustomer()" id="customer_id" style="width: 100%;">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="text" name="p_discount" class="form-control" autocomplete="off" data-date-format="yyyy-mm-dd" value="{{ old('p_discount') }}" id="t_date" placeholder="Date">
                        @error('p_discount')
                          <p class="text-danger">{{ $errors->first('p_discount') }}</p>
                        @enderror
                      </div>
                    </div>
...
$('#project_category').on("change",function(){
      ...
      let link = "{{ route('inventory.customer.account.project-ajax-customer') }}";
      $.ajax({
          type: "GET",
          url: link,
          data: { cus_id: cus_id},
