...
@if ($user->user_type == 2)
    ...
    @section('payment_collection','active')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Supplier's Payment Collection</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-6 offset-md-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('inventory.supplier.accounts.payment-collection-store') }}" method="post">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="b_id"  style="width: 100%;">
