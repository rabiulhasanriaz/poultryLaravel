        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Total Project List</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example" class="display nowrap" style="width:100%">
                  ...
                  <tbody>
                      ...
                      @php
                          $projects = \App\Models\Project::totalProject($item->id);
                      @endphp
                      <tr>
                          <td>{{ $loop->iteration }}</td>
                          <td>{{ $item->customerInfo->cus_name }}</td>
                          <td class="text-center">{{ $projects }}</td>
                          <td>
                              <a href="{{ route('inventory.project.project-details',$item->customer) }}">View Details</a>
                          </td>
                      </tr>
                      @endforeach
                  </tbody>
