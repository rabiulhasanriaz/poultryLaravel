            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">{{ $customer->customerInfo->cus_name }}'s Projects Details</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example" class="display nowrap" style="width:100%">
                      ...
                      <tbody>
                          ...
                          @php
                            $total = App\Models\ProductInventory::totalInvoices($item->id);
                            $totalAmount = App\Models\ProductInventory::projectAmount($item->id);
                          @endphp
                          <tr>
                              ...
                              <td>
                                  <a href="{{ route('inventory.project.project-invoice',$item->id) }}">
                                      View Details
                                  </a>
                              </td>
