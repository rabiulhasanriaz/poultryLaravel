...
@if ($user->user_type == 2)
    ...
    @section('list_type_class','active')
            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Total Type List</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                          ...
                          <tr>
                              ...
                              <td><div class="btn-group">
                                  ...
                                  <div class="dropdown-menu" role="menu">
                                    <a class="dropdown-item" onclick="typeUpdate('{{ $item->id }}')" href="#">Update</a>
      ...
      <div class="modal fade" id="typeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body" id="typeData">
              ...
            </div>
...
<script>
  function typeUpdate(value) {
    $.ajax({
      type: "GET",
      url: "{{ route('inventory.product.type.type-ajax') }}",
      data: {value:value},
